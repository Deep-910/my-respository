...
function IndustryScientific() {
    ...
    useEffect(() => {
        fetch('http://localhost/waltzify_copy/frontend/src/Database/Fetch_Categories/fetch_IndustryScientific.php')
...
export default IndustryScientific;